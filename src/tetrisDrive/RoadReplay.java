...
public class RoadReplay extends JPanel implements ActionListener, Runnable{
   ...
   String nameLog;
    ...
    public RoadReplay(String _nameLog) { /**конструктор с запуском таймера*/
    	this.nameLog = _nameLog;
    	System.out.println("Road nameLog="+nameLog);
    	player = new Replay(this);
